...
import DeviceDetailsBox from './deviceDetailsBox'
import DeviceReservationsList from './devicesReservationsGrid'
        ...
        <ThemeProvider theme={theme}>
          ...
          <Container component="main" style={{ maxWidth: 'fit-content',  }}  >
            <Paper variant="outlined" sx={{ my: { xs: 8, md: 6 }, p: { xs: 2, md: 3 } }} maxWidth="fit-content" >
              <DeviceDetailsBox></DeviceDetailsBox>
              <DeviceAccessList></DeviceAccessList>
              <DeviceHistoryList></DeviceHistoryList>
              <DeviceReservationsList></DeviceReservationsList>
            </Paper>
          </Container>
        </ThemeProvider>
      );
